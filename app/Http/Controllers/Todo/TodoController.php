...
class TodoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('todo')->with('success', 'Task baru ditambahkan');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('todo')->with('success', 'Task diperbarui');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('todo')->with('success', 'Task dihapus');
    }
}
